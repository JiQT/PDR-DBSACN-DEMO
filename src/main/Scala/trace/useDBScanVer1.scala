...
//
//import dbscan.{DBSCAN, DBSCANLabeledPoint, DBSCANPoint, LocalDBSCAN, LocalDBSCANArchery, LocalDBSCANNaive}
//import org.apache.spark.SparkContext
//import org.apache.spark.mllib.linalg.Vectors
//import org.apache.spark.rdd.RDD
//import org.apache.spark.sql.{DataFrame, SparkSession}
//import trace.userTrace.NowDate
//
///**
// * @Time：2021/6/4
// * @Author：JiQT
...
//    } yield point
//
//    val labeledPoints = new LocalDBSCAN(eps, minPts).fit(duplicated.toLocalIterator.toIterable)
...
//    val value = labeledPoints.map(p => (p.x,p.y,p.cluster) )
//    import spark.implicits._
//    val valueRDD= sc.parallelize(value.toSeq)
//    val resDF: DataFrame = valueRDD.toDF("longitude","latitude","cluster")
//    resDF.createOrReplaceTempView("temp")
//    spark.sql("create table resTraceNav as select * from temp")
